		...
		<nav class="container navigation post-navigation my-5">
			...
			<div class="row nav-links justify-content-between">
				...
				if ( get_previous_post_link() ) {
					previous_post_link( '<span class="nav-previous h5">%link</span>', _x( '<i class="fa fa-arrow-left pr-3"></i>&nbsp;%title', 'Previous post link', 'understrap' ) );
				}
				if ( get_next_post_link() ) {
					next_post_link( '<span class="nav-next h5">%link</span>', _x( '%title&nbsp;<i class="fa fa-arrow-right pl-3"></i>', 'Next post link', 'understrap' ) );
				}
				?>
			</div><!-- .nav-links -->
		</nav><!-- .navigation -->
